package com.github.educooper.citiesapi.cities.repositories;
import com.github.educooper.citiesapi.cities.entities.City;
import org.springframework.data.jpa.repository.JpaRepository;
import org.springframework.data.jpa.repository.Query;

public interface CityRepository extends JpaRepository<City, Long> {
    /*OPERADOR <@> Criado com instalação do comando CREATE EXTENSION earthdistance; o qual força o calculo de distância dentro da query do DB */
